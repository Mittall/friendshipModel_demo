...
class FriendRequestsControllerTest < ActionController::TestCase
  ...
  test "should create friend_request" do
    assert_difference('FriendRequest.count') do
      post :create, friend_request: { requested_user_id: @friend_request.requested_user_id, status: @friend_request.status, user_id: @friend_request.user_id }
    end
  ...
  test "should update friend_request" do
    patch :update, id: @friend_request, friend_request: { requested_user_id: @friend_request.requested_user_id, status: @friend_request.status, user_id: @friend_request.user_id }
    assert_redirected_to friend_request_path(assigns(:friend_request))
  end
